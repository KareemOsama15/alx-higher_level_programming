...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        method that returns the biggest rectangle object
        ...
        Raises:
            TypeError: if rect_1 not instance of Rectangle class
            TypeError: if rect_2 not instance of Rectangle class

        Returns:
            the biggest Rectangle object
